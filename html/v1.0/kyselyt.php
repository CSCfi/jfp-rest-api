...
$hae_julkaisunkanvan_tiedot="SELECT IFNULL(Jufo_ID, '') as Jufo_ID, IFNULL(Level, '') as Level ,IFNULL(Name, '') as Name, IFNULL(Abbreviation, '') as Abbreviation, 
...
IFNULL(p.Denmark_Level, '') as Denmark_Level, IFNULL(p.SJR_SJR, '') as SJR_SJR, IFNULL(p.SNIP, '') as  SNIP, IFNULL(p.IPP, '') as IPP, IFNULL(p.DOAJ_Index, '') as DOAJ_Index, IFNULL(p.Sherpa_Romeo_Code, '') as Sherpa_Romeo_Code, IFNULL(p.CreatedAt, '') as CreatedAt, IFNULL(p.ModifiedAt, '') as ModifiedAt, IFNULL(p.Active_Binary, '') as Active_Binary ,IFNULL(p.Jufo_2012, '') as Jufo_2012, IFNULL(p.Jufo_2013, '') as Jufo_2013, IFNULL(p.Jufo_2014, '') as Jufo_2014, IFNULL(p.Jufo_2015, '') as Jufo_2015, '' as Fields, 
IFNULL(p.Scientific, '') as Scientific, IFNULL(p.Professional, '') as Professional, IFNULL(p.Jufo_History, '') as Jufo_history, IFNULL(p.Substitutive_Channel, '') as Substitutive_Channel, IFNULL(p.Grounds_Removal, '') as Grounds_Removal FROM Publications p WHERE p.jufo_ID = %PARAM1%;";
...
from Publications where Type = '%PARAM3%' and issn1 like '%%PARAM2%%' or issn2 like '%%PARAM2%%';";
...
from Publications where Type = '%PARAM3%' and isbn like '%%PARAM2%%';";
...
from Publications where Type = '%PARAM3%' and Abbreviation like '%PARAM2%%';";
